...
class S3DIS(Dataset):
    def __init__(self, num_points=4096, partition='train', test_area='1'):
        ...
        self.alpha_list = [0 for _ in range(13)]
        for i in range(13):
...
def load_Toronto3D(partition, test_area):
    DATA_DIR = r'E:\SemanticKitti\SemanticKitti'
...
class Toronto3D(Dataset):
    def __init__(self, num_points=4096, partition='train', test_area='2'):
